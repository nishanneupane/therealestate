...
const Hero = () => {
    ...
    return (
        <div className="relative w-full h-[600px] overflow-hidden mt-10 z-0">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 md:px-6 max-w-7xl mx-auto pt-16">                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-center mb-8 max-w-4xl">
